...
function AlbumsForUser(props) {
  ...
  async function loadPage(pageNumber = page, shouldRefresh = false) {
    ...
    const response = await fetch(`http://jsonplaceholder.typicode.com/albums?_start=${pageNumber - 1}&_limit=10&userId=${userId}`);
...
export default connect(mapStateToProps)(AlbumsForUser);